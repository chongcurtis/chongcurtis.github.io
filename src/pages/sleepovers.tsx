        ...
        <div className="flex flex-col justify-center align-center max-w-3xl place-items-center mx-auto">
            ...
            <div className="px-5">
                <div>
                    ...
                    <br />
                    <br />
                    <p className="fade-in-on-scroll">Sleepovers at the Office is my weekly newsletter. It&apos;s a
                        collection of tech-related
                        project
                    ...
                    <br /><br />
                    <p className="fade-in-on-scroll text-sleepover-primary text-xl">Why is it called Sleepovers at the
                        Office?</p>
                    <br />
                    <p className="fade-in-on-scroll">When the Coronavirus came, the CEO at Lumina graciously allowed me
                        to stay at the office to
                        shelter from the disease. I was without words when they offered me a place to stay, so I decided
                        to
                        name my newsletter after what happened.</p>
                    <br />
                    <ThinLine />
                    <p className="fade-in-on-scroll mt-2">Here&apos;s what an email might look like:</p>
                    <div className="flex fade-in">
                        <div
                            ...
                            <br />
                            <br />
                            <p className="fade-in-on-scroll">What if we could redirect them so that instead of hitting
                                Florida, they remain in the
                                Atlantic before dying off?</p>
                            <br />
                            <br />
                            ...
                            <ol className="list-decimal ml-[20px] mt-4 mb-6 marker:font-extrabold marker:text-slate-800 marker:text-center">
                                <li className="fade-in-on-scroll mb-2 pl-2">Predict where/when a storm will form.</li>
                                <li className="fade-in-on-scroll mb-2 pl-2">Send a fleet of 50 planes near that area.
                                    They will create
                                    clouds
                                    to reflect
                                    sunlight
                                ...
                                <li className="fade-in-on-scroll mb-2 pl-2">This change in atmosphere will deviate the
                                    storm from its
                                    initial
                                    path, saving
                                    billions
                            ...
                            <br />
                            <p className="fade-in-on-scroll">The hard part is telling the planes where to fly.
                                We&apos;ll need the following:</p>
                            ...
                            <br />
                            <p className="fade-in-on-scroll">It&apos;d be breathtaking to see aircraft carriers launch
                                hundreds of jets to redirect
                                the tempest.</p>
                            <br />
                            <br />
                            <p className="fade-in-on-scroll">We may not even need planes to fly; autonomous drones could
                                be enough. Since this is a
                                control problem, we&apos;ll need extremely responsive agents, i.e. computers.</p>
                            <br />
                            <br />
                            <p className="fade-in-on-scroll">On the other hand, this technology may encourage more
                                development in hazardous areas because people may falsely assume that this technology
                                will work all the time. There are also ethical concerns. If you can redirect storms away
                                from people, you certainly have the means to direct them toward people…</p>
                            <br />
                            <br />
